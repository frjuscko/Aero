...
<head>
    ...
    <title>Aero Framework — <?php echo htmlspecialchars((string)($code) ?? "", ENT_QUOTES); ?></title>
    <link rel="stylesheet" href="<?php echo htmlspecialchars((string)(asset('/css/app.css')) ?? "", ENT_QUOTES); ?>">
    <style>
...
<body>
    ...
    <nav class="aero-nav">
        <div class="aero-container nav-content">
            <a href="<?php echo htmlspecialchars((string)(route('home')) ?? "", ENT_QUOTES); ?>" class="logo">Aero<span>.</span></a>
            <div class="nav-links">
                <a href="<?php echo htmlspecialchars((string)(route('home')) ?? "", ENT_QUOTES); ?>">Accueil</a>
                <a href="<?php echo htmlspecialchars((string)(route('home')) ?? "", ENT_QUOTES); ?>">Dashboard</a>
            </div>
        </div>
    </nav>
    ...
    <div class="error-wrapper">
        <div class="error-card">
            ...
            <div class="error-code"><?php echo htmlspecialchars((string)($code) ?? "", ENT_QUOTES); ?></div>
            ...
            <div class="hero-actions">
                <a href="<?php echo htmlspecialchars((string)(route('home')) ?? "", ENT_QUOTES); ?>" class="btn btn-primary">Réinitialiser les propulseurs</a>
            </div>
        </div>
    </div>
